...
class Expense(models.Model):
    ...
    accounting_seat = models.ForeignKey(Contact, on_delete=models.CASCADE, related_name='ExpenseContactSeats')
...
class Purchase(models.Model):
    ...
    accounting_seat = models.ForeignKey(Contact, on_delete=models.CASCADE, related_name='PurchaseContactSeats')
    invoice_date = models.DateField()
    due_date = models.DateField()
    description = models.TextField()
...
class Asset(models.Model):
    ...
    accounting_seat = models.ForeignKey(Contact, on_delete=models.CASCADE, related_name='AssetContactSeats')
    invoice_date = models.DateField()
    due_date = models.DateField()
    description = models.TextField()
